...
Replay::Message::FoundKeysForReduce - signal that we are reconciling a state
...
This is a message normally generated by the storage engine on initialize
the control channel listeners that the particular record is now in need of
being reduced
