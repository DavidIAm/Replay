...
An as yet undefined process which should run at a system startup that scans
the system to find data that is not in its reduced form but needs to be. This
is likely to be followed by a bunch of Reducable messages
