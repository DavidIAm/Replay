...
Replay::Message::Unlocked - a StorageEngine message
...
This is a message normally generated by the StorageEngine role informing other
actors in the system that a locked document was unlocked, probably by checking
in a new canonical state. It is defined to enable other elements of the system
