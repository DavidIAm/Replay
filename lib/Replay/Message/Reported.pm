...
Replay::Message::Reported - a report message
...
This is a message normally generated by the Reportengine role informing other
actors in the system that a fresh version of a report document has been made
available so that they may take proactive action
