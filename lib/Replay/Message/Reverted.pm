...
Replay::Message::Reverted - a storage message
...
actors in the system that a reverted document has occured in teh storage engine.
This indicates a bad operation - usually that something crashed or was unable
to be processed. System health is poor if you see these messages.
