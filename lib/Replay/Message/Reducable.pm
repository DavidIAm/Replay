...
Replay::Message::Reducable - a StorageEngine message
...
Issued by the StorageEngine to indicate a transition to the state of neeeding
to be reduced. This is normally listened to by the Reducer process to pick up
pieces of work to process.
