...
Replay::Message::Clearing::Error - for the clearing rule
...
This is a message abnormally generated by the clearing engine rule
implementation indicating that an error state has been reached
