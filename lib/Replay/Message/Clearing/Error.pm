...
Replay::Message::Clearing::Error - signal that a error has been encountered while
processing a clearing state
...
This is a message normally generated by the clearing rule reduce routine that informs
the processing system that there is an error during processing for a clearing state
