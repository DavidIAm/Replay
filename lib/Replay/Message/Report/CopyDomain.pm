...
has '+MessageType' => (default => 'CopyDomain');
...
Replay::Message::CopyDomain - signal that a domain should be copied
...
the control channel listener that a domain copy is desired 
