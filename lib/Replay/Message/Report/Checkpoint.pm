...
Replay::Message::Report::Checkpoint - signal that a checkpoint has been commited
...
the control channel listener that a checkpoint has been commited to storage
