...
has '+MessageType' => (default => 'Checkpoint');
...
Replay::Message::Checkpoint - signal that a checkpoint should occur
...
This is a message normally generated by the Management system that informs
the control channel listener that it is time to initiate a checkpoint
