...
Replay::Message::Fetched - a StorageEngine message
...
elements of the system that a particular document was fetched out of the
storage. It might be used for auditing purposes!
