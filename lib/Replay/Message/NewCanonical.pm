...
the control channel listener that a new canonical state is now available
on the indicated key

This message is probably going to be listened for by a clerk class worker,
which will then fetch that state and format it for a report.
