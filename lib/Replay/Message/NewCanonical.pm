...
Replay::Message::NewCanonical - a storage message
...
actors in the system that a new canonical value has been stored in the system
so they may take proactive action
