...
Replay::Message::Async - a Clearing machine message
...
This is a message normally generated by the Clearing Machine rule, probably
to initiate a placeholder plus timeout operation to back up an asynchronous 
process or retrieval.
