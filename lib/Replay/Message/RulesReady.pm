...
Replay::Message::RulesReady - signal that the rules engine is ready
...
This is a message normally generated by the bureaucrat or rules engines 
storage engine that informs the control channel listeners that it is now 
ready to deliver rule information
