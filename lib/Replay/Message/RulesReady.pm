...
Replay::Message::RulesReady - a RuleSource message
...
This is a message normally generated by the RuleSource role informing other
actors in the system that initialization is complete and requests for rules
may now take place.
