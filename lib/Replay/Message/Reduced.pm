...
Replay::Message::Reduced - a StorageEngine message
...
This is a message normally generated by the Reducer role, informing other
elements of the system that a particular state has been succesffully processed.
Probably useful for auditing and system pattern observation
