...
the control channel listeners that all of the canonical states for a 
particular window were delivered to a requester.

It is probably the clerk that would have requested this data in order to run 
the summarize rule.
