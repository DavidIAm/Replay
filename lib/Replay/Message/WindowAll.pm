...
Replay::Message::WindowAll - a StorageEngine message
...
elements of the system that the data for all of the keys under a particular 
window have been retrieved, as would happen during Report generation.
