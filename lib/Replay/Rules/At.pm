package Replay::Rules::At;

# This state encapsulates the outstanding requests to send messages at a later
# time
#
# AT rule
# The various messages we've been asked to send
#
# sendMessageAt message
# kvs At ####000 domain {sendtime, payload}
#
# sendAtTiming message
# kvs At ####000 domain {time}
#
# reduce
#   if the send time is past the oldest sendATiming
#     emit message, emit sentMessageAt {domain, key} and drop
#   retain other sendtime atoms
